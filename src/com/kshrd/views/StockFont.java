...
public class StockFont {

    public static final int ART_SIZE_SMALL = 8;
    ...
    public enum ASCIIArtFont {
        ...
        ART_FONT_MONO("Monospaced"),ART_FONT_SERIF("Serif"), ART_FONT_SANS_SERIF("SansSerif"),ART_FONT("Times New Roman")
        ;
    ...
    public static void Stockfont() throws Exception {
        StockFont artGen = new StockFont();


        System.out.println();
        artGen.printTextArt("S T O C K  M A N A G E M E N T", StockFont.ART_SIZE_SMALL, ASCIIArtFont.ART_FONT,"4");
        System.out.println();
    }
